...
/** Насколько заранее просим кадры, которых ещё нет. Переход теперь всегда
 *  ведёт к соседнему кадру, так что запаса хватило бы и меньшего; при восьми
 *  кадрах это значит, что в простое поднимается вся стопка, кроме двух
 *  последних, а они приходят по первому же onNeed. */
const LOOKAHEAD = 5;
